...
MATERIAL_FIELDS: list[MaterialField] = [
    ...
    MaterialField("address_is_hk", "住址是否香港", required=False),
    MaterialField("director_surname_en", "英文姓氏", required=False),
    MaterialField("director_given_en", "英文名字", required=False),
